...
if ($title === '') {
    die("Vui lòng nhập tiêu đề lịch trình.");
}

if (!isset($_FILES['image']) || $_FILES['image']['error'] !== 0) {
    die("Vui lòng chọn ảnh lịch trình.");
}

$upload_dir = "../uploads/itineraries/";
...
$stmt = $conn->prepare("
    INSERT INTO itineraries (title, image, sort_order, is_active)
    VALUES (?, ?, ?, ?)
");
...
if ($stmt->execute()) {
    ...
    echo "Lỗi khi thêm lịch trình: " . $stmt->error;
}
